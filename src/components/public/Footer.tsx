        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              <a
                href="https://www.facebook.com/tuperil.net?locale=es_LA"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/5 text-gray-500 hover:bg-[#1877F2] hover:text-white hover:scale-110 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.instagram.com/tuperfilnet/?hl=es"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/5 text-gray-500 hover:bg-gradient-to-tr hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF] hover:text-white hover:scale-110 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
              ...
              <a
                href="https://www.youtube.com/@tuperfilnet6894"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/5 text-gray-500 hover:bg-[#FF0000] hover:text-white hover:scale-110 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
                aria-label="YouTube"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://www.tiktok.com/@tuperfilnet"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/5 text-gray-500 hover:bg-black hover:text-white hover:scale-110 hover:-translate-y-0.5 transition-all duration-200 cursor-pointer"
                aria-label="TikTok"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
